 ...
 *
 * This file is copied and modified, starting from the PCB Gtk port.
 *
...
void
ghid_button_connected (GtkWidget *box,
                       GtkWidget **button,
                       gboolean pack_start,
                       gboolean expand,
                       gboolean fill,
...
void
ghid_coord_entry (GtkWidget *box,
...
void
ghid_spin_button (GtkWidget *box,
