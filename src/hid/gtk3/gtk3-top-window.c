/*!
 * \file src/hid/gtk3/gtk3-top-window.c
 *
 ...
 *
 * \warning Some caveats with menu shorcut keys:  Some keys are trapped
 * out by Gtk and can't be used as shortcuts (eg. '|', TAB, etc).
...
#include "gtk3-icons-mode-buttons.data"
#include "gtk3-icons-misc.data"
#include "gtk3-trackball.h"
...
/*!
 * \brief Save size of top window changes so PCB can restart at its size
 * at exit.
 */
static gint
